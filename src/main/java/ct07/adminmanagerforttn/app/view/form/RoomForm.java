 ...
 */
public class RoomForm extends javax.swing.JPanel {
    ...
    private void initDataInTable(){
        ...
        if (this.roomController.roomResponse != null && !this.roomController.roomResponse.isEmpty()) {
            for (int i = 0; i < this.roomController.roomResponse.size(); i++) {
                this.room = this.roomController.roomResponse.get(i);
    ...
    private void setRoomDetailForm(int id){
        roomController.setRoomDetailForm(this, id);
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tiêu đề", "Mô tả", "Người đăng", "Nội thất", "Diện tích", "Tiền phòng", "Tiền cọc", "Trạng thái"
            }
        ) {
